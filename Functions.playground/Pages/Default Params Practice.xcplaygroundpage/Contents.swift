...
func endOfTheYearBonues(basePay: Double, bonus: Double, percentBonus: Double = 0.10)->Double{
    return basePay + bonus + (basePay*percentBonus)
}

endOfTheYearBonues(basePay: 5000, bonus: 1000)
endOfTheYearBonues(basePay: 5000, bonus: 1000, percentBonus: 0.2)
